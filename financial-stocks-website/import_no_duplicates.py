...
# List of tickers
tickers = [
    'aapl', 'msft', 'amzn', 'googl', 'meta', 'fb', 'jpm', 'tsla', 'brk', 
    'nvda', 'hd', 'pypl', 'v', 'pg', 'ma', 'crm', 'abt', 'wmt', 'dis', 'unh'
]
...
for ticker in tickers:
    table_name = 'stocks'  # The table name is always 'stocks'
    symbol = ticker.upper()  # Stock symbol in uppercase
